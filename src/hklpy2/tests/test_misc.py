...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            HAT_Y,
            HAT_Z,
            pytest.raises(ValueError, match="Vector norm is zero"),
        ...
        pytest.param(
            ...
            np.array([0, np.inf, 0]),
            HAT_Z,
            pytest.raises(ValueError, match="Vector norm is not finite"),
        ...
        pytest.param(
            ...
            HAT_Y,
            [1, 1, 1],
            pytest.raises(ValueError, match="Vectors are not orthogonal."),
            id="Not orthogonal",
        ),
    ],
)
